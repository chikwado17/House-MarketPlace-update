...
const EditListing = () => {
    ...
    useEffect(() => {
      ...
      const fetchEditListing = async () => {
        ...
        if(docSnap.exists()) {
          ...
          //spreading the form with data from firestore for edit
          setFormData({...docSnap.data()})

          setLoading(false);
        }else {
          navigate('/');
          toast('Could not edit listing');
        }
    ...
    //storing userRef AS logged in user from firestore
    useEffect(() => {
